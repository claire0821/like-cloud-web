  ...
  <div class="index-lists">
    ...
    <el-card class="!border-none mt-4" shadow="never">
      ...
      >
        ...
        <el-table-column label="显示状态" prop="showStatus" min-width="100">
...
import { brandDelete, brandLists, brandUpdateStatus } from "@/api/brand";
...
const updateBrandStatus = async (data: any) => {
  await brandUpdateStatus({ brandId: brandId, showStatus: showStatus });
};
getLists();
</script>
