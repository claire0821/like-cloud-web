    ...
    >
      ...
      >
        ...
        <el-form-item label="读取状态 1-已读 0-未读" prop="readState">
          <el-radio-group
            v-model="formData.readState"
            placeholder="请选择读取状态 1-已读 0-未读"
          >
        ...
        <el-form-item label="推送状态1-已推送 0-未推送" prop="pushState">
          <el-radio-group
            v-model="formData.pushState"
            placeholder="请选择推送状态1-已推送 0-未推送"
          >
            <el-radio label="0">请选择字典生成</el-radio>
          </el-radio-group>
        </el-form-item>
...
const handleSubmit = async () => {
  ...
  mode.value == "edit"
    ? await notice_systemEdit(data)
    : await notice_systemAdd(data);
