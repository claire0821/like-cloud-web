        ...
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                <el-form-item label="仓库" prop="wareId">
                    <el-select v-model="queryParams.wareId" placeholder="请选择仓库" clearable>
                        <el-option
                            :label="w.name"
                            :value="w.id"
                            v-for="w in wareList"
                ...
                <el-form-item label="sku_Id" prop="skuName">
                    <el-input class="w-[200px]" v-model="queryParams.skuId" />
                </el-form-item>
                <el-form-item label="sku_name" prop="skuName">
                    <el-input class="w-[200px]" v-model="queryParams.skuName" />
                </el-form-item>
                <el-form-item>
...
import { skuDeleteBatch, skuLists } from '@/api/ware/sku'
