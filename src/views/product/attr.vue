        ...
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="是否需要检索[0-不需要，1-需要]" prop="searchType">
                    <el-select v-model="queryParams.searchType" class="w-[280px]" clearable>
                ...
                <el-form-item
                    ...
                    prop="attrType"
                >
                    <el-select v-model="queryParams.attrType" class="w-[280px]" clearable>
                        <el-option label="请选择字典生成" value="" />
                    </el-select>
                </el-form-item>
...
import { attrDelete, attrLists } from '@/api/product/attr'
