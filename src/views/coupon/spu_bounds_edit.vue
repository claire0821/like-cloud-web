            ...
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                >
                    <el-checkbox
                        ...
                        :true-label="1"
                        :false-label="0"
                        placeholder="请选择优惠生效情况[1111（四个状态位，从右到左）;0 - 无优惠，成长积分是否赠送;1 - 无优惠，购物积分是否赠送;2 - 有优惠，成长积分是否赠送;3 - 有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】]"
                    ></el-checkbox>
                </el-form-item>
            </el-form>
        </popup>
...
import { boundsEdit, boundsAdd, boundsDetail } from '@/api/coupon/spu_bounds'
    ...
    work: [
        {
            required: true,
            message:
                '请选择优惠生效情况[1111（四个状态位，从右到左）;0 - 无优惠，成长积分是否赠送;1 - 无优惠，购物积分是否赠送;2 - 有优惠，成长积分是否赠送;3 - 有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】]',
            trigger: ['blur']
        }
    ]
}
